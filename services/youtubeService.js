...
// ======================
// DIRECT STREAM UPLOAD (UNLISTED)
// ======================

export const uploadToYoutube = async (video) => {
  try {
    console.log('STARTING YOUTUBE STREAM UPLOAD')
    ...
    console.log('CLOUDINARY STREAM READY')
...
export const makeVideoPublic = async (youtubeVideoId) => {
  try {
    console.log('MAKING VIDEO PUBLIC')
